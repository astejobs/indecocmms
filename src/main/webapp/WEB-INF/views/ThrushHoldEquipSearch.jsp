			 ...
			 <div class="container" style="width:100%;">
			    ...
			    <div class="col-xs-8 col-sm-8 col-lg-8 col-md-8">
		            ...
		            <form:form action ="${Search}"  commandName="equipmentSearchCriteria" class="form contact-form" id="contact_form">
		              ...
		              <form:select path="equipmentType" id="sysId" name="sysId" class="input-md round form-control" >
                                     ...
                                     <form:options items="${types}"  itemValue="assetTypeName" itemLabel="assetTypeName"></form:options>
                                       ...
                                       </div><form:hidden path="workspace"/>
                                        <div class="form-group">
                                         
                                            <form:select path="assetSubtype" id="subsysId" name="subsysId" class="input-md round form-control">
					...
					<div class="form-group">
	                          ...
	                          <td><input type="hidden" value="${equipment.id}"
											name="id" />
	                          <a href="#" id="${equipment.id}" onclick="javascript:changeParent(this.id)" >${equipment.name}</a></td>
												...
												<tr>
												 <td><c:if test="${page>1}">
															...
															<a class="page-far-left"
																href="<c:url value="/predictive/pageno=1"/>"><img style="width:10px;height:12px" src="${pageContext.servletContext.contextPath}/resources/assets/images/pre.png"></a>
	
															<a class="page-left"
															   style="color:#fff;cursor:pointer;text-decoration:none;" href="<c:url value="/predictive/pageno=${page-1}"/>">&nbsp;<< </a>
															...
															<c:forEach var="i" begin="${from}" end="${to}">
																...
																<c:choose>
																	...
																	<c:otherwise>
																		<a class=""
																			href="<c:url value="/predictive/pageno=${i}"/>"
															...
															<a class="page-right"
																href="<c:url value="/predictive/pageno=${page+1}"/>"></a>
															 ...
															 <c:if test="${page<total}">
																...
																<a class="page-far-right"
																	 href="<c:url value="/predictive/pageno=${total}"/>" ><img style="width:10px;height:12px;top:-1px;position:relative" src="${pageContext.servletContext.contextPath}/resources/assets/images/next.png"></a>
															</c:if>
														</c:if>
														</td>
