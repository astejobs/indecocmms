	...
	<nav class="navbar navbar-inverse navbar-second">
		<div id="navbar" class="collapse navbar-collapse navbar-responsive-collapse outerUl">
            ...
            <li class="dropdown innerUl">
			    ...
			    <li class="mobile-view-only"><a href="${pageContext.servletContext.contextPath}/logout"><i class="fa fa-sign-out"></i>  Logout (<sec:authentication property="principal.username" />)</a></li>
