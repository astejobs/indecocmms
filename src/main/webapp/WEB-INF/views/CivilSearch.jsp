		         ...
		         <div class="row">
		           ...
		           <div class="col-xs-9 col-sm-9 col-lg-9 col-md-9">
                    <h2 class="section-title font-alt align-left mb-70 mb-sm-40" style="margin-bottom:20px;position:relative;border-bottom:1px dashed #808080">
                      ...
                      <c:url value="/civil/search" var="actionsubmit"></c:url>
                      <c:url value="/civil/edit" var="editlink"/>
                      <c:url value="/civil/delete" var="deletelink"/>
                    ...
                    <div class="form-group" >
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <td></td>
                                <td></td>
                                 <td><a id="edit" href="${editlink}/${civilList.id}" style="cursor:pointer">
                                 <i class="fa fa-edit"> </i></a>
                                 <a id="delete" href="${deletelink}/${civilList.id }" style="cursor:pointer">
