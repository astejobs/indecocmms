    ...
    border-color: #0754a4;
        ...
        <section class="small-section bg-dark-alfa-30 parallax-2" style="margin-bottom:-70px;position:relative" data-background="${pageContext.servletContext.contextPath}/resources/assets/images/full-width-images/section-bg-18.jpg">
            <div class="relative container align-left">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="hs-line-11 font-alt mb-10 mb-xs-0" style="margin-top:5px">RFA's FROM APPROVER</h1>
                    </div>

                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a class="label-click" href="${pageContext.servletContext.contextPath}/dashboard">Dashboard</a>&nbsp;/&nbsp;<a class="label-click" href="">RFA's from Approver</a>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-toggle="tooltip" data-placement="bottom" title="Approver Date ">Approver Date </th>
                                                         <th data-toggle="tooltip" data-placement="bottom" title="Financer Date">Financer Date</th>
                                                 ...
                                                 <tbody>
                                                   ...
                                                   <p class="mar" data-toggle="tooltip" data-placement="bottom" title="${q.quotationCode} "> ${q.quotationCode}  </p>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="bottom" title="${requests.finStatus}">${requests.finStatus}</td>
                                                   ...
                                                   <td><a href="<c:url value="/requestForApproval/viewRequest"><c:param name="id" value="${requests.id}"/><c:param name="user" value="PO"/></c:url>"
