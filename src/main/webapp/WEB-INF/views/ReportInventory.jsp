       ...
       <div style="height:100px;position:relative"></div>
           ...
           <jsp:include page="/WEB-INF/views/menu.jsp" />
             ...
             <div class="col-xs-9 col-sm-9 col-lg-9 col-md-9">
               ...
               <c:url value="/inventory/reports/consumption" var="consumptionReport"></c:url>
               <c:url value="/inventory/reports/parts" var="partsReport"></c:url>
                    <p style="color:#000;left:7%;position:relative">Inventory Reports</p>
                </div>
                <!-- Works Grid -->
