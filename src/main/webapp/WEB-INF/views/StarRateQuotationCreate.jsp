...
<c:choose>
				...
				<c:url value="/quotation/updatestarratequotation" var="updateUrl"/>
				...
				<c:otherwise>
				<c:url value="/quotation/addstarratequotation" var="addurl" />
 ...
 <!-- Head Section -->
        ...
        <section class="small-section bg-dark-alfa-30 parallax-2" style="margin-bottom:-70px;position:relative" data-background="${pageContext.servletContext.contextPath}/resources/assets/images/full-width-images/section-bg-18.jpg">
            <div class="relative container align-left">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="hs-line-11 font-alt mb-10 mb-xs-0" style="margin-top:5px">CREATE STAR RATE</h1>
                    </div>

                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a class="label-click" href="${pageContext.servletContext.contextPath}/dashboard">Dashboard</a>&nbsp;/&nbsp;<a class="label-click" href="">Create Star Rate</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="clearfix">
                                    <div>
                                        <h2 class="section-title font-alt align-left mb-70 mb-sm-40" style="margin-bottom:20px;position:relative;border-bottom:1px dashed #808080">
                                            ${submit_caption} Star Rate Quotation
                                        </h2>
                                       ...
                                       <div class="form-group">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><input style="width: 127px;" type="text"   class="othervendorcost"   name="otherVendorEquipmentList[${i.index}].cost" value="${othervendorequip.cost}"></td>
                                                       <td><a class="btn-tr-remove" style="margin-left: 25px;"><i class="fa fa-trash" ></i></a></td>
                                                    </tr>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="form-group">
                                            <input type="text" style="float:right;"  readonly name="subtotal" id="otherveneqsubtotal" class="input-md round col-lg-3" placeholder="Sub Total" />
                                        </div>
                                        <div class="clearfix"></div><br />
                                      ...
                                      <div style="display:inline-block">
                                        ...
                                        <div style="display:inline-block" >
                                            ...
                                            <form:input type="text" style=" width: 95px;" path="emergencyOrDiscountPercent" id="emerper" class="input-md round " />
                                    ...
                                    <div style="display:inline-block">
                                        ...
                                        <div style="display:inline-block">
                                            ...
                                            <input style="width: 282px;" type="text"  id="emeramt" class="input-md round " placeholder="Emergency or Discount Amount" readonly="true" />
                                        ...
                                        &nbsp;&nbsp; &nbsp;&nbsp;
                                        <div style="display:inline-block">
                                            <form:input type="text"  path="gst" id="gst" class="input-md round " placeholder="GST in %" />
                                        </div>
                                        &nbsp;&nbsp; &nbsp;&nbsp;
                                        <div style="display:inline-block">
