...
<body class="appear-animate">
    ...
    <!-- Page Wrap -->
        ...
        //Filter Tab
			$(document).ready(function(){
				$("#processorTasksId").find("option").eq(0).hide();
				$("#processorTasksId01").find("option").eq(0).hide();
			})
            $(function () {
            ...
            $('#addTaskButton').on('click', function () {
                ...
                if (taskId == '1')
                {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        ...
                        + '<td><input type="text" class="other-11" name="criteria[' + count + '].valuee" style="width:200px"></td>'
                ...
                if (taskId == '3') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        ...
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Department 1</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '4') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        ...
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><input class="other-11" name="criteria[' + count + '].valuee" style="width:200px" type="text"></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '5') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><input type="text" class="other-11" name="criteria[' + count + '].valuee" id="criteria[' + count + '].value" style="width:200px"  placeholder="Reported Date"/><img src="../assets/images/date/cal.png" onclick="javascript: NewCssCal(\'criteria[' + count + '].value\',\'ddMMyyyy\')" style="cursor:pointer;width:20px" /></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '6') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face"name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Location 1</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '7') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Building</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '8') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                ...
                if (taskId == '9') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Fault Code</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '10') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Priority</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '11') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                ...
                if (taskId == '12') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Main Grp</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '13') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                ...
                if (taskId == '18') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Client</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '19') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                ...
                if (taskId == '21') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><input class="other-11" name="criteria[' + count + '].value" style="width:200px" type="text"></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                ...
                if (taskId == '23') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
                        + '<td class="taskDescriptionCol">' + task + '<input value="' + taskId + '" type="hidden" class="face" name="criteria[' + count + '].tableColumn.id" >' + '</td>'
                        + '<td><select class="other" style="width:100px" name="criteria[' + count + '].conditionn"><option value="Equal">Equal</option><option value="Not">Not</option><option value="Like">Like</option></select></td>'
                        + '<td><select class="other-11" name="criteria[' + count + '].valuee" style="width:200px"><option>Amdad</option></select></td>'
                        + '<td><a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer"><i style="cursor:pointer" class="fa fa-trash"> </i></a></td></tr>');
                }
                if (taskId == '24') {
                    $('#tasksTable').append('<tr><td class="taskIdCol" style="display:none">' + taskId + '</td>'
            ...
            $(document).on('click', '.btn-tr-remove', function (e) {
                ...
                if ($('#tasksTable tr').length > 1) {
                    ...
                    $('input[class="other-11"]').attr("name", function (i) {
	...
	<div class="row">
        <div class="col-md-12">
        	<div class="col-md-10 jumbotron offset-box">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                             <c:url value="/selfHelp/updateadhocReport" var="updatereport"/>
                              <form:form method="post" action="${updatereport}" class="form contact-form" id="contact_form" commandName="adhocreport">
                              <form:hidden path="id"/>
                              ...
                              <form:hidden path="createdDate"/>
                                        <div class="form-group input-group">
                                            ...
                                            <form:input type="text"  readonly="true" path="adhocReportForm" name="report_name" id="report_name" class="input-md round form-control" placeholder="Report Name"/>
                                        </div>
                                       <div class="form-group input-group">
                                        	<span class="input-group-addon label-left" id="basic-addon2">Report Name</span>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <form:textarea   path="description" class="input-md round form-control" rows="3" placeholder="Description"></form:textarea>
                                ...
                                <div class="bs-example">
                                    ...
                                    <div class="tab-content">
                                        <div id="columns" class="tab-pane fade in active">
                                            ...
                                            $(document).ready(function () {
                                            	$("#tOne > tbody > tr").first().next().hide();
                                            	$("#tOne > tbody > tr").first().next().next().hide();
                                        	});

                                                $(document).ready(function () {
                                                    $("body").on('click', '#tOne tbody .stuList', function (e) {
                                                        var counter = $("#tbl2  tbody  tr").length;
                                            ...
                                            <p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <c:forEach items="${adhocreport.columnList}" var="col" varStatus="index">
                                                            <tr class="thClas">
                                                            <td>
															${col.tableColumn.columnDesc}
															<input class="other-1" value="${col.tableColumn.id}" name="columnList[${index.index}].tableColumn.id" type="hidden">
															</td>
																<td align="center" width="40px">
                                                             <input id="stu_id[]" class="stuList mir"  data-value="FR.NO." type="checkbox">
                                                             </td>
                                                             <td class="remStu" style="text-decoration:underline;cursor:pointer">
															<a>
															<img src="../assets/images/trash..png" style="height:20px;width:20px">
															</a>
															</td>
                                        ...
                                        <div id="filter" class="tab-pane fade">
                                            <p>
                                                ...
                                                <table id="tasksTable">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${adhocreport.criteria}" var="criterea" varStatus="count">
                                                    <tr>
													<td class="taskIdCol" style="display:none">1</td>
													<td class="taskDescriptionCol">
													${criterea.tableColumn.columnDesc}
													<input class="face" value="${criterea.tableColumn.id}" name="criteria[${count.index}].tableColumn.id" type="hidden">
													</td>
													<td>
													<select class="other" style="width:100px" name="criteria[${count.index}].conditionn" >
													<c:if  test="${criterea.conditionn eq 'Equal'}">
													 <option selected="selected" value="Equal">Equal</option>
													 <option  value="Not">Not</option>
													 <option  value="Like">Like</option>
													 </c:if>
													 <c:if  test="${criterea.conditionn eq 'Not'}">
													<option selected="selected" value="Not">Not</option>
													 <option value="Equal">Equal</option>
													  <option  value="Like">Like</option>
													</c:if>
													<c:if  test="${criterea.conditionn eq 'Like'}">
													...
													<td>
													<input class="other-11" name="criteria[${count.index}].valuee" value="${criterea.valuee}" style="width:200px" type="text">
													</td>
													<td>
													<a class="btn-tr-remove" style="color:black;margin-left: 25px;cursor:pointer">
                                        ...
                                        <div id="sorting" class="tab-pane fade">
                                            <p>
                                                ...
                                                <table id="tasksTable01">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${adhocreport.sort}" var="sort" varStatus="index">
                                                    <tr id="sort[01]">
														<td class="taskIdCol01" style="display:none">${sort.column.id}</td>
														<td class="taskDescriptionCol01">
														FR.NO.
														<input class="face-1" value="${sort.column.id}" name="sort[${index.index}].Column.id" type="hidden">
														</td>
														<td>
														<c:if test="${sort.sortOrder eq 'ASC'}">
														<input class="Casc" checked="checked" name="sort[${index.index}].sortOrder" value="ASC" type="radio">
														Asc 
														<input class="descd" name="sort[${index.index}].sortOrder" value="DESC" type="radio">
														Desc
														</c:if>
														<c:if test="${sort.sortOrder eq 'DESC'}">
														<input class="Casc"  name="sort[${index.count}].sortOrder" value="ASC" type="radio">
														Asc  
														<input class="descd" checked="checked" name="sort[${index.index}].sortOrder" value="DESC" type="radio">
														Desc
														</c:if>
														</td>
														<td>
														<c:if test="${sort.groupBy eq 'true'}">
														<input class="ch-Class" name="sort[${index.index}].groupby" checked="checked" type="checkbox">
														</c:if>
														<c:if test="${sort.groupBy eq 'false'}">
														<input class="ch-Class" name="sort[${index.index}].groupby"  type="checkbox">
														</c:if>
														</td>
														<td>
														<a class="btn-tr-remove-01" style="color:black;margin-left: 25px;cursor:pointer">
														<i class="fa fa-trash" style="cursor:pointer"> </i>
														</a>
														</td>
														</tr>
                                            ...
                                            <p>
                                                <input type="button" id="addTaskButton01" value="Add" class="btn"/>
                                            </p>
                                        </div>
                                    </div>
                                </div>
