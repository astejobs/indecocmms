    ...
    border-color: #0754a4;
        ...
        <section class="small-section bg-dark-alfa-30 parallax-2" style="margin-bottom:-70px;position:relative" data-background="${pageContext.servletContext.contextPath}/resources/assets/images/full-width-images/section-bg-18.jpg">
            <div class="relative container align-left">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="hs-line-11 font-alt mb-10 mb-xs-0" style="margin-top:5px">LIST OF RFA's FROM HQ REVIEWER</h1>
                    </div>

                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a class="label-click" href="${pageContext.servletContext.contextPath}/dashboard">Dashboard</a>&nbsp;/&nbsp;<a class="label-click" href="">RFA's from HQ Reviewer</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="clearfix">
                                    <div>
                                        <h2 class="section-title font-alt align-left mb-70 mb-sm-40" style="margin-bottom:20px;position:relative;border-bottom:1px dashed #808080">
                                            List of RFA's from HQ Reviewer
                                        </h2>
                                            ...
                                            <table class="table table-stripped" id="datatable"  data-paging="true"  data-filtering="true">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th  data-toggle="tooltip" data-placement="bottom" title="HQ Reviewer Date">HQ Reviewer Date</th>
                                                        <th  data-toggle="tooltip" data-placement="bottom" title="Approver Date">Approver Date</th>
                                                 ...
                                                 <tbody>
                                                  ...
                                                  <p class="mar" data-toggle="tooltip" data-placement="bottom" title="${q.quotationCode}">  ${q.quotationCode} </p>
                                                    ...
                                                    <td  data-toggle="tooltip" data-placement="bottom" title="${requests.appStatus}">${requests.appStatus}</td>
                                                    <td  data-toggle="tooltip" data-placement="bottom" title="${requests.costCenterdate}"><fmt:formatDate pattern="dd-MM-yyyy" 
                                                       value="${requests.costCenterdate}"/></td>
                                                    <td  data-toggle="tooltip" data-placement="bottom" title="${requests.approverDate}"><fmt:formatDate pattern="dd-MM-yyyy" 
                                                       value="${requests.approverDate}"/></td>
                                                     <td  data-toggle="tooltip" data-placement="bottom" title="${requests.totalPriceQuoted}">${requests.totalPriceQuoted}</td>
                                                   <td><a href="<c:url value="/requestForApproval/viewRequest"><c:param name="id" value="${requests.id}"/><c:param name="user" value="approver"/></c:url>"
