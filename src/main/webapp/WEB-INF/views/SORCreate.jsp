       ...
       <!-- Head Section -->
        <section class="small-section bg-dark-alfa-30 parallax-2" style="margin-bottom:-70px;position:relative" data-background="${pageContext.servletContext.contextPath}/resources/assets/images/full-width-images/section-bg-18.jpg">
            <div class="relative container align-left">
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="hs-line-11 font-alt mb-10 mb-xs-0" style="margin-top:5px">CREATE SOR</h1>
                    </div>

                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a class="label-click" href="${pageContext.servletContext.contextPath}/dashboard">Dashboard</a>&nbsp;/&nbsp;<a class="label-click" href="">Create SOR</a>
                        </div>
                    </div>
                </div>
            </div>
		           ...
		           <div class="col-xs-9 col-sm-9 col-lg-9 col-md-9">
                    <h2 class="section-title font-alt align-left mb-70 mb-sm-40" style="margin-bottom:20px;position:relative;border-bottom:1px dashed #808080">
                        Create New SOR 
       						...
       						<c:url value="/SOR" var="submit"/>
                            <form:form  action="${submit}" method="post"  class="form contact-form" modelAttribute="SOR" commandName="SOR" id="contact_form">
                                    ...
                                    <form:select path="equipmentType" id="EqType" class="input-md round form-control">
                                                <form:option value="">Select Asset Type</form:option>
                                                <form:options items="${assetType}"  itemValue="assetTypeName" itemLabel="assetTypeName"></form:options>
                                    </form:select><form:errors class="err" path="equipmentType" ></form:errors>
                                       ...
                                       <form:errors  class="err" path="equipmentName"></form:errors>
                                            </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="button" onclick="location.href='${pageContext.servletContext.contextPath}/SOR/search';" value="Search"/>
