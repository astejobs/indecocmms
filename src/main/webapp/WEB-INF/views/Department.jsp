	...
	<div class="row">
        <div class="col-md-12">
        	<div class="col-md-10 jumbotron offset-box">
                         	<c:url value="/department/delete" var="delete"/>
            		                   <form:form action="${delete}" class="form contact-form" id="contact_form">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover" id="tblResult">
                                                ...
                                                <tbody>
                                                <c:url value="/department/edit" var="edit_link"></c:url>
 ...
 <tr><td colspan="100%" class="bac" style="border-bottom: 1px solid #FFF"><div class="form-group"> <input type="submit" id="submit" class="btn" value="Delete" /> </div> </td> </tr>
														  ...
														  <ul class="pagination pagination-sm pagination-sm-left" style=" position: relative;" >		
																<c:if test="${page>1}">
																	...
																	<li>	<a class="page-far-left"
																			href="<c:url value="/department/pageno=1"/>"><<</a>  </li>
															<li>			<a class="page-left"
																			href="<c:url value="/department/pagenoo=${page-1}"/>"><</a> </li>
																	</c:if>
																	<c:forEach var="i" begin="${from}" end="${to}">
																			...
																			<c:choose>
																				...
																				<c:otherwise>
																			<li>		<a class=""
																						href="<c:url value="/department/pageno=${i}"/>" 
																						>${i}</a> </li>
																				</c:otherwise>
																			</c:choose>
																		</c:forEach>
																	...
																	<li>	<a class="page-right" 
																		 	href="<c:url value="/department/pageno=${page+1}"/>">> </a>  </li>
															<li>			<a class="page-far-right"
																		    href="<c:url value="/department/pageno=${total}"/>" >>></a> </li>
																	</c:if>
																	</ul>
																	</td>
																</tr>
                    			 ...
                    			 <c:choose> 
										  ...
										  <c:when test="${not empty edit}">
												<c:set value="/department/update" var="action"/>
											...
											<c:otherwise>
												 <c:set value="/department/add" var="action"/>
                                   ...
                                   <form:form   method="post" action="${submit}" commandName="department" class="form contact-form" id="contact_form">
                                      <form:hidden path="id"/>
                                       <input type="hidden" name="p" value="${page}"/>     
                                           <div class="form-group input-group">
                                        	<span class="input-group-addon label-left" id="basic-addon2">Department ID</span>
                                            <form:input type="text" path="name"  class="input-md round form-control" placeholder="Department ID"  required="required"/>
                                                      <form:errors class="err"  path="name"/>
                                        </div>
                                        <div class="form-group input-group">
                                        	<span class="input-group-addon label-left" id="basic-addon2">Description</span>
                                            <form:textarea   path="description" class="input-md round form-control" placeholder="Department Description*" required="required"/>
